...
% invece va bene in png per JACMP 11.25cm = 4.2 inches
    ...
    hold on
    plot(Totm_10cm_NotNorm(:,1)./10,Totm_10cm_NotNorm(:,2),'-','LineWidth',1,'MarkerSize',20);   
...
%     hlCoarse = line(AnglesAbscissa,coarse,'LineWidth',1.5,'Color','g');    
    ...
    lh1 = legend('Sum', 'Location','NorthEast');
    legend('boxoff')
