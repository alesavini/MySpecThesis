...
% invece va bene in png per JACMP 11.25cm = 4.2 inches
    ...
    plot(Totc_10cm_002(:,1)./10,Totc_10cm_002(:,2),'-.','LineWidth',0.1,'color',myColors(3,:));
    plot(Totc_10cm_005(:,1)./10,Totc_10cm_005(:,2),'-','LineWidth',0.1,'color',myColors(2,:));
    plot(Totc_10cm_01(:,1)./10,Totc_10cm_01(:,2),'-.','LineWidth',0.1,'color',myColors(6,:));
...
%     set(ax1,'YLim',[0 175]);%Metto le ordinate il massimo del misurato più un nticchia così si visualizza bene
    set(ax1,'XLim',[-15 15]);
