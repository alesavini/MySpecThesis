...
\begin{figure}
\centering
a)\includegraphics[width=.45\textwidth]{./cap2/MLC_leaf_varian.png}\\
b)\includegraphics[width=.4\textwidth]{./cap2/MLC_side.png}
c)\includegraphics[width=.4\textwidth]{./cap2/MLC_front.png}
