...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{./cap2/Ray_spectrum_ele.eps}
...
\subsection{Profili - Off-axis softening, beam profile correction e sorgenti di scatter}
...
\subsection{Dimensione della sorgente primaria}
...
\begin{figure}
\centering
\includegraphics[width=.48\textwidth]{./cap2/Ray_wrong_penumbra.PNG}
\includegraphics[width=.48\textwidth]{./cap2/Ray_right_penumbra.PNG}
\caption{Sinistra: una sorgente troppo estesa ($0.1\,$cm) porta ad una sovrastima delle penombre del profilo di dose di dimensioni $2x2$. Destra: dimensioni della sorgente ottimizzate ($0.042\,$cm).}
...
\end{itemize}
In questo caso è stato necessario violare leggermente i limiti suggeriti della ditta per ottimizzare al meglio l'accordo delle penombre.
