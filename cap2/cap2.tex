...
\begin{figure}
\centering
\includegraphics[width=.6\textwidth]{./cap2/MLC_tip_model.png}
\caption{Modello della punta dei leaf implementato in RayStation. La punta arrotondata viene schematizzata come una regione rettangolare con trasmissione pari alla radice quadrata della trasmissione del leaf. La largezza di questa regione è il parametro da ottimizzare in fase di modellizzazione del MLC.}
