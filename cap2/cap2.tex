...
Tuttavia, le raccomandazioni ESTRO sconsigliano di valutare l'accettabilità del calcolo di un profilo o PDD con un criterio puntuale bensì di utilizzare un criterio globale basato sul livello di confidenza dell'indice $\gamma$ introdotto da Venselaar et al.\cite{Venselaar2001}:
\begin{equation}
