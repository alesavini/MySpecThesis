...
In particolare sono stati utilizzati i diodi PFD e Razor (IBA Dosimetry) per le seguenti scansioni:
...
Tutte le misure elencate, assieme alle misure di dose assoluta (Sez.\ref{sec:dose_ass}), sono state inserite nel modulo del TPS denominato RayPhysics ed utilizzate per sviluppare un modello dosimetrico del LINAC come presentato nella sezione successiva.
