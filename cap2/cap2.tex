...
\begin{figure}[!t]
\centering
\includegraphics[width=.9\textwidth]{./cap2/OF_plots/OFCC13.eps}\\
\includegraphics[width=.9\textwidth]{./cap2/OF_plots/OFSmall.eps}
...
\label{fig:OF_res}
\end{figure}
Si può notare che la misura degli output factor per piccoli campi presenta un certo grado di variabilità a seconda del detector utilizzato. Le variabilità più ampie si riscontrano per i campi di dimensione minore $\leq 1x1\,$cm$^c$.
