...
\caption{La punta arrotondata del leaf comporta un effetto dosimetrico evidente in caso di campi adiacenti. Nel nostro caso le penombre dei due campi si sommano dando luogo ad un incremento della dose (a \textit{spike}) nella zona di giunzione. I profili di dose sono acquisiti ad una profondità di $10\,$cm in fantoccio ad acqua con il detector Razor (IBA Dosimetry, vedi Tab.\ref{tab:OF_inter}).}
...
CONTINUARE QUI DICENDO CHE QUESTI EFFETTI VANNO CONSIDERATI INIMRT (HUQ) e quindi dire che ci siamo inventati questi campi per poi modellizzarci sopra...vedi se prima introdurre come fa il TPS a modellarli e poi dire come abbiamo fatto noi.....forse è meglio. Magari dici che serve tenerne conto (HUQ) poi dici come Ray ne tiene conto e poi COME NOI abbiamo ottimizzato quei parametri.





PRIMA EVIDENZIARE QUALCHE STUDIO RIGUARDO LA TG E LEAS TIP E DIRE QUANTO PUò INCIDERE facendo vedere che è rilevante..HUQ è perfetto in questo senso..POI METTERE COME RAYSTATION TIENE CONTO DI QUESTI DETTAGLI con le foto del reference manual
