...
\end{itemize}
La modellizzazione dell'effetto di leaf tip è stata in seguito verificata utilizzando campi adiacenti lontano dall'asse centrale.
\begin{figure}
\centering
...
\end{tabular}
\caption{Sinistra: Modello della punta dei leaf implementato in RayStation. Destra: Modellizzazione dell'effetto di leaf tip.}
