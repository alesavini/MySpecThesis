...
\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{./cap2/ModelingSteps/ModelingSteps.pdf}
...
I profili dei campi di dimensione $\leq 4x4\,$cm$^2$ sono stati tenuti in relativa considerazione in questa fase in quanto gli effetti sopra descritti costituiscono un fenomeni del secondo ordine rispetto agli effetti collegati alla dimensione della sorgente primaria.
