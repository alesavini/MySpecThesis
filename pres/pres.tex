...
\includegraphics[height=4cm]{../cap2/OF_plots/OFSmall.eps}
...
{\color{Dgreen} \textbf{Scelta:} considerate per il commissioning solo le misure con dimensione di campo $> 2x2\,cm^2$.}
