...
\item[d)] Infine $\rightarrow$ misura di dose assoluta (in Gy) in un punto che trasforma tutte le curve di dose relativa in dose assoluta.
$$D(Gy) = M_{raw}\,N_{d,w}\,k_{Q,Q_0}\,k_{TP}\,k_h\,k_{pol}\,k_{sat}\qquad (\textrm{IAEA TRS-398})$$
\end{itemize}
\end{frame}
